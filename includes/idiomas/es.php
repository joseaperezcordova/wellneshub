...
return [
    // ---- Marca ----
    'marca.nombre'    => 'Omdara',
    'marca.subtitulo' => 'Donde el bienestar conecta.',
    ...
    'evento.editar.retirar'         => 'Retirar actividad',
    'evento.editar.confirmar_retirar' => '¿Retirar «%s»? Deja de verse en Omdara, pero no se borra.',
    ...
    'ficha.btn.reactivar'        => 'Reactivar',
    'ficha.btn.editar'           => 'Editar',
    'ficha.btn.ocultar'          => 'Ocultar',
    'ficha.btn.cancelar'         => 'Cancelar actividad',
    'ficha.prompt_info_cancelacion' => '¿Algo que quieras decirle a quienes ya la tenían planeada? Se mostrará junto al aviso de cancelada. Déjalo vacío para omitirlo.',
    ...
    'ficha.fecha_actualizada.etiqueta' => 'FECHA ACTUALIZADA',
    'ficha.fecha_actualizada.texto'    => 'La fecha de esta actividad fue modificada recientemente.',
