...
return [
    ...
    'evento.form.url_compra_label'   => 'Link to buy tickets',
    'evento.form.url_reserva_label'  => 'Link to book or register',
    'evento.form.url_compra_ayuda' => 'Add the link where people can buy tickets or pay/sign up. For example: Eventbrite, Boletia, Ticketmaster, your website or a payment landing page.',
    'evento.form.url_reserva_ayuda' => 'Add the link where people can book their spot or register. It can be WhatsApp, Google Forms, Calendly, your own form or a registration landing page.',
    ...
    'evento.form.seccion2'           => '2. Schedule type',
    'evento.form.fecha_especifica' => 'Specific date',
    'evento.form.reserva' => 'By booking / availability',
    'evento.form.programacion_recurrente_label' => 'Frequency / schedule',
    'evento.form.programacion_recurrente_placeholder' => 'Every Tuesday at 6:00 p.m.',
    'evento.form.programacion_recurrente_ayuda' => 'Example: "Monday, Wednesday and Friday from 8:00 to 9:00 a.m." You don\'t need to add each date.',
    'evento.form.programacion_reserva_label' => 'Availability / how to book',
    'evento.form.programacion_reserva_placeholder' => 'Sessions available Monday to Friday. Times subject to availability. Contact the organizer to check times and book.',
    'evento.form.programacion_reserva_ayuda' => 'For activities without a fixed date where the time is agreed with the organizer: personal Pilates, personal training, massages, private sessions or one-on-one classes.',
    'evento.form.vigencia_ayuda' => 'Recurring and by-booking activities are shown for one month. When they are about to expire you can renew them with one click, without filling them in again.',
    'programacion.recurrente' => 'Recurring',
    'programacion.reserva' => 'By booking',
    ...
    'evento.form.recurrente'         => 'Recurring',
    ...
    'evento.editar.retirar'         => 'Withdraw activity',
    'evento.editar.confirmar_retirar' => 'Withdraw "%s"? It stops showing on Omdara, but isn\'t deleted.',
    ...
    'evento.valida.programacion_recurrente_falta' => 'Write the frequency and schedule.',
    'evento.valida.programacion_reserva_falta' => 'Write the availability or how to book.',
    'evento.valida.programacion_larga' => '500 characters max.',
    ...
    'ficha.barra.cancelada_tit'      => 'Cancelled.',
    'ficha.barra.cancelada_texto'    => 'Still visible to the public, with the cancelled notice.',
    'ficha.barra.publicada_tit'      => 'Published.',
    'ficha.barra.publicada_texto' => 'You can edit, cancel or withdraw it whenever you want.',
    'ficha.vigencia.hasta' => 'Shown until %s.',
    'ficha.vigencia.vencida' => 'Its month has ended: it doesn\'t show in listings or search until you renew it.',

    'ficha.btn.publicar'         => 'Publish',
    'ficha.btn.volver_publicar'  => 'Publish again',
    'ficha.btn.reactivar'        => 'Reactivate',
    'ficha.btn.editar'           => 'Edit',
    'ficha.btn.ocultar'          => 'Hide',
    'ficha.btn.cancelar'         => 'Cancel activity',
    'ficha.prompt_info_cancelacion' => 'Anything you want to tell people who already had this planned? It\'ll show next to the cancelled notice. Leave it blank to skip.',
    ...
    'ficha.btn.renovar' => 'Renew for a month',
    'ficha.aviso.renovado' => 'Done: your activity is shown for one more month.',
    ...
    'ficha.fecha_actualizada.etiqueta' => 'DATE UPDATED',
    'ficha.fecha_actualizada.texto'    => 'This activity\'s date was recently changed.',
    ...
    'tarjeta.fecha_actualizada' => 'Date updated',

    'ficha.btn.comprar_boletos' => 'Buy tickets',
    'ficha.btn.reservar'        => 'Book a spot',
